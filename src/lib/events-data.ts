...
export const events: EventItem[] = [
  ...
  },
  {
    ...
    description:
      "An amazing magic show party for kids! Enjoy an incredible magic performance, fun games, dancing, and a kids lunch included. Perfect for the whole family. 57 Union St, Newton Centre, MA. Call 617-762-7830.",
    ticketUrl: undefined,
    eventType: "FAMILY PROGRAMS",
  },
  {
  ...
  },
  {
    ...
    alt: "Super Magic Show Party for kids at Cafe St. Petersburg",
    description:
      "Another magical Sunday for kids! Amazing magic show, games, dancing, and kids lunch included. 57 Union St, Newton Centre, MA. Call 617-762-7830.",
    ticketUrl: undefined,
    eventType: "FAMILY PROGRAMS",
  },
  {
