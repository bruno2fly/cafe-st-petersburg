...
export const menuChapters: MenuChapter[] = [
  ...
  },
  {
    ...
    featureSpotlight: {
      ...
      image: "/images/food/cafe-st-pete-rack-of-lamb.png",
    },
    items: [
      ...
      { name: "Ribeye Steak", price: 53, image: "/images/food/cafe-st-pete-ribeye-steak.png", description: "Prime ribeye steak, hand-selected and grilled to perfection." },
    ],
  },
  {
    id: "sides",
