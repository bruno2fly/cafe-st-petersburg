...
export const menuChapters: MenuChapter[] = [
  {
    ...
    items: [
      { name: "Traditional Hand Pies (Pirozhki)", price: 5, description: "Baked hand pies filled with a variety of savory fillings, baked until golden and crispy." },
      ...
      { name: "Pickled Vegetable Starter", price: 15, description: "Crunchy cucumbers, tangy cabbage, juicy cherry tomatoes, house-pickled with fresh herbs, garlic, aromatic spices." },
      { name: "Herring Spread (Farshmak)", price: 16, description: "Velvety house-made herring pâté blended with butter, onion, and spices. Served chilled with rye crisps." },
      { name: "Chicken Liver Pâté", price: 17, description: "Velvet-smooth pâté finished with honey and sea salt, served with handmade crispy crostini." },
      { name: "Kholodets (Studen)", price: 17, description: "Traditional slow-simmered chicken and beef aspic, set in a clear savory jelly. Served with spicy mustard and horseradish." },
      { name: "Herring with Potatoes & Onions", price: 18, description: "Tender salted herring with fried crispy potatoes, fresh dill, pickled red onions, aromatic sunflower oil." },
      ...
      { name: "Meat Platter", price: 23, description: "Premium house-roasted meats and traditional cured selections with handmade spicy mustard and horseradish." },
  ...
  },
  {
    ...
    bgColor: "cream",
    items: [
      { name: "Alaska Finest Red Caviar — 2 oz (56g)", price: 30, description: "Premium Alaskan salmon roe with vibrant pop, clean ocean flavor, and delicate salinity." },
      { name: "Roe Acipenser Black Caviar — 2 oz (56g)", price: 95, description: "Premium Acipenser sturgeon black caviar, prized for its delicate texture and refined flavor." },
      { name: "Add Blini", price: 2, description: "House-made golden blini to accompany your caviar selection." },
    ],
  },
  {
    id: "salads",
    ...
    items: [
      ...
      { name: "Caesar Salad", price: 16, description: "Crisp romaine, tender grilled chicken, parmesan shavings, house-made croutons, and bold Caesar dressing. Add grilled chicken $5 | Add grilled shrimp $7" },
      { name: "Olivier Salad (Classic)", price: 17, description: "Traditional potato salad with peas, carrots, pickles in creamy mayonnaise, served with roasted chicken. Substitute to grilled beef steak $2" },
      { name: "Herring Under a Fur Coat", price: 17, description: "Classic layered salad of beets, potatoes, carrots, eggs, and herring with light mayonnaise." },
      { name: "Burrata with Truffle", price: 19, description: "Creamy burrata with marinated tomatoes, basil sauce, finished with truffle oil." },
    ],
  },
  {
    id: "soups",
    ...
    items: [
      { name: "Mushroom Cream Soup", price: 16, description: "Velvet-smooth roasted mushroom soup finished with premium truffle oil and fresh herbs." },
      { name: "Classic Borscht", price: 18, description: "Deep-ruby beet soup slow-simmered with tender beef, shredded cabbage, root vegetables. Served with sour cream, dark rye bread, house-cured salo, scallions." },
      { name: "Solyanka", price: 18, description: "Bold tomato-based soup with house-cured and roasted meats, tangy pickles, olives, lemon. Served with sour cream and fresh bread." },
  ...
  },
  {
    ...
    items: [
      { name: "Handmade Vareniki", price: 21, description: "Dumplings filled with potatoes, topped with creamy mushroom sauce." },
      { name: "Handmade Pelmeni", price: 23, description: "Traditional dumplings filled with seasoned veal and pork." },
      { name: "Stuffed Cabbage Rolls | Golubtsy", price: 28, description: "Tender cabbage leaves stuffed with seasoned ground beef, rice, and herbs, slow-braised in a rich tomato-sour cream sauce." },
      { name: "Carp Cutlets", price: 29, description: "Tender golden carp cutlets pan-seared to perfection, served with a creamy house sauce, cherry tomatoes, and fresh greens." },
      { name: "Beef Stroganoff", price: 30, description: "Sautéed beef with onions and mushrooms in silky cream sauce, with mashed potatoes and pickles." },
      { name: "Chicken Kiev", price: 30, description: "Chicken breast stuffed with green herb butter, breaded and fried golden, served with mashed potatoes." },
      { name: "Pozharsky Cutlet", price: 30, description: "Hand-chopped chicken cutlet with crispy breadcrumbs, served with mashed potatoes and our signature parsnip white sauce." },
      { name: "Chicken Tabaka", price: 33, description: "A whole young chicken, marinated in aromatic spices and grilled under pressure until crispy golden all over. A Caucasian classic." },
      { name: "Baked Salmon", price: 33, description: "Fresh salmon baked tender and flaky, finished with lemon and herbs, served with vegetables, bread and olives." },
