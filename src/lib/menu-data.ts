...
export const menuChapters: MenuChapter[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Carp Cutlets", price: 2, image: "/images/food/carp-cutlets-new.jpg"9, image: "/images/food/carp-cutlets-new.jpg", description: "Tender golden carp cutlets pan-seared to perfection, served with a creamy house sauce, cherry tomatoes, and fresh greens." },
