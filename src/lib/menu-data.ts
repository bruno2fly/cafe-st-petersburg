...
export const menuChapters: MenuChapter[] = [
  {
    ...
    items: [
      ...
      { name: "Boyar-Style Hand Pie with Oxtail", price: 8, image: "/images/food/Cafe St. Petersburg_pirozhki_01092025_052.jpg", description: "Premium hand pies filled with braised oxtail, a traditional and hearty option." },
      ...
      { name: "Kholodets (Studen)", price: 17, image: "/images/food/Cafe St. Petersburg_pickled zakuska_01092025_050.jpg", description: "Traditional slow-simmered chicken and beef aspic, set in a clear savory jelly. Served with spicy mustard and horseradish." },
      ...
      { name: "Salo Platter", price: 18, image: "/images/food/Cafe St. Petersburg_pickled zakuska_01092025_049.jpg", description: "Pieces of cured pork lard served with mustard — traditional, bold, and melt-in-the-mouth." },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Add Blini", price: 2, image: "/images/food/blini-red-caviar.jpg", description: "House-made golden blini to accompany your caviar selection." },
    ],
  },
  {
    id: "salads",
    ...
    bgColor: "cream",
    items: [
      { name: "Vinegret", price: 16, image: "/images/food/beet-cream-eggplant.jpg", description: "Beet and vegetable salad with potatoes, carrots, pickles, and onions, lightly dressed with oil." },
      { name: "Classic Garden Salad", price: 16, image: "/images/food/pickled-veg-trio.jpg", description: "Fresh seasonal vegetables — tomatoes, cucumbers, radishes, and greens — lightly dressed with olive oil and lemon." },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Tabaka", price: 33, image: "/images/food/chicken-tabaka.jpg", description: "A whole young chicken, marinated in aromatic spices and grilled under pressure until crispy golden all over. A Caucasian classic." },
      ...
      { name: "Braised Oxtail", price: 36, image: "/images/food/Cafe St. Petersburg_meat platter_01092025_033.jpg", description: "Slow-braised oxtail until the meat falls from the bone, served in a rich deep sauce with root vegetables. Deeply warming and intensely flavorful." },
      ...
      { name: "Royal Sturgeon", price: 38, image: "/images/food/fish-platter-pan.jpg", description: "Grilled sturgeon fillet, oven-finished and served with a house honey-spiced sauce and fresh mixed greens." },
